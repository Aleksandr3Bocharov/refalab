...
lib\obj\mainrf_dbg.o (для запуска РефалАБ-программы в режиме отладки),
lib\obj\rfdbg.o (для запуска отладчика РефалАБ-программы)
и lib\obj\rfdbg_dbg.o (для запуска отладчика РефалАБ-программы в режиме отладки).
