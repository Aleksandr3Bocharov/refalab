...
имеются интерфейсные функции transplantation и after_duplicate.
...
ОБЪЯВЛЕНИЕ: extern T_LINKCB *after_duplicate(const T_LINKCB *before, const T_LINKCB *after, const T_LINKCB *before_duplicate);

ОБРАЩЕНИЕ: after_duplicate(before, after, before_duplicate);
...
его можно представить в виде E.x E.z, то after_duplicate вырабатывает ненулевое
значение указателя на звено, следущее за E.x, т.е. на звено, с которого
начинается E.z. Если же E.y невозможно представить в виде E.x E.z, то after_duplicate
