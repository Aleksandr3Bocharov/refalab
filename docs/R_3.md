...
ПАРАМЕТРЫ:
- big_number - указатель на целое число в выражении;
- before - указатель на звено, предшествующее целому числу в выражении;
- after - указатель на звено, следующее за целым числом в выражении.

ИСПОЛЬЗОВАНИЕ:

Пытается прочитать целое число в выражении big_number, находящееся между before и after.
