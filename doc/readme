...
размещена на сайте http://www.refal.net (ссылки приведены в
файле url_doc.txt).

В документации по системе Рефал-2 (R_0..R_5.txt), входящей в
дистрибутив, вместо почти всего раздела R_4.txt 
(4.Компиляция и исполнениеРЕФАЛ-программ), который пока не приведен 
в соответствие с нынешней версией, следует использовать информацию из 
refal2/readme по запуску тестовых примеров. Раздел по использованию
отладчика (4.5.Средства отладки) остается в силе, только вместо cld.bat 
используется r2cld.bat.
