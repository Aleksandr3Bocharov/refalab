...
void print_status_table(T_STATUS_TABLE *status_table, bool additional_info)
{
...
int8_t compare_big_numbers(const T_BIG_NUMBER *big_number1, const T_BIG_NUMBER *big_number2)
{
