...
extern void function_definition(const char *identifier, uint8_t identifier_length, size_t cursor_number);
extern void specifier_definition(const char *identifier, uint8_t identifier_length, size_t cursor_number);
extern T_LABEL *function_reference(const char *identifier, uint8_t identifier_length, size_t cursor_number);
